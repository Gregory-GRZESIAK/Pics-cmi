...
class systemecentree():
    ...
    def calc_and_print_result(self):
        ...
        print('fo : {},   fi : {}'.format(round(self.fo, 3), round(self.fi, 3)))
        print("EHo : {},    ENo : {}".format(round(self.EHo, 3),round(self.ENo, 3)))
        print("SHi : {},    SNi : {}".format(round(self.SHi, 3),round(self.SNi, 3)))
        print("HoNo : {},     HiNi : {},   fo+fi={}".format(round(-self.EHo+self.ENo, 3),round(-self.SHi+self.SNi, 3),round(self.fo+self.fi, 3)))
        print("EFo : {},    SFi : {}".format(round(self.EFo, 3),round(self.SFi, 3)))
